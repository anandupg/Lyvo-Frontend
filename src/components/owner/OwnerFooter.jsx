        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-sm text-gray-600 mb-4 max-w-md">
              Streamline your property management operations with our comprehensive platform designed for property owners and managers.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/owner-dashboard" className="text-sm text-gray-600 hover:text-gray-900">Dashboard</Link>
              </li>
              <li>
                <Link to="/owner-properties" className="text-sm text-gray-600 hover:text-gray-900">Properties</Link>
              </li>
              <li>
                <Link to="/owner-tenants" className="text-sm text-gray-600 hover:text-gray-900">Tenants</Link>
              </li>
              <li>
                <Link to="/owner-settings" className="text-sm text-gray-600 hover:text-gray-900">Settings</Link>
              </li>
            </ul>
          </div>
