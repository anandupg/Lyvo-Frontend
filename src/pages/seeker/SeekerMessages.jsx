...
const SeekerMessages = () => {
  ...
  // Mock data for conversations with property owners
  const [conversations] = useState([
    {
      ...
      lastMessage: "The maintenance request has been approved. Plumber will visit tomorrow.",
      ...
      messages: [
        ...
        },
        {
          id: 2,
          sender: "owner",
          text: "Hello! What's the issue with the sink?",
          timestamp: "10:32 AM",
          status: "read"
        },
        {
        ...
        },
        {
          id: 6,
          sender: "owner",
          text: "The maintenance request has been approved. Plumber will visit tomorrow.",
          timestamp: "10:45 AM",
          status: "read"
        }
      ]
    },
    {
      ...
      messages: [
        ...
        },
        {
          id: 2,
          sender: "owner",
          text: "Thank you! I've received the payment",
          timestamp: "9:20 AM",
          status: "read"
        },
        {
          id: 3,
          sender: "owner",
          text: "Your rent payment has been received. Thank you!",
          timestamp: "9:25 AM",
          status: "read"
        }
      ]
    },
    {
      ...
      lastMessage: "Yes, you can extend your lease. Let me send you the details.",
      ...
      messages: [
        ...
        },
        {
          id: 2,
          sender: "owner",
          text: "Hello! Yes, I can see that. What are your plans?",
          timestamp: "8:05 AM",
          status: "read"
        },
        {
        ...
        },
        {
          id: 4,
          sender: "owner",
          text: "Yes, you can extend your lease. Let me send you the details.",
          timestamp: "8:15 AM",
          status: "read"
        }
      ]
  ...
  const filteredConversations = conversations.filter(conv =>
    ...
    conv.owner.property.toLowerCase().includes(searchTerm.toLowerCase())
  );
        ...
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className={`${
            ...
            <div className="p-4 bg-red-600 text-white">
              ...
              <p className="text-xs sm:text-sm text-red-100">Chat with property owners</p>
            </div>
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className="relative">
                      ...
                      />
                      <div className={`absolute -bottom-1 -right-1 w-3 h-3 rounded-full border-2 border-white ${getStatusColor(conversation.owner.status)}`}></div>
                    </div>
                      ...
                      >
                        <div className={`max-w-[280px] sm:max-w-xs lg:max-w-md px-4 py-3 rounded-2xl ${
                          ...
                          <div className={`flex items-center justify-end mt-2 space-x-1 ${
                            msg.sender === 'seeker' ? 'text-red-100' : 'text-gray-400'
                          }`}>
