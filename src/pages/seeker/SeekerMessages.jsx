    ...
    try {
      ...
      const transformedChats = chats.map(chat => ({
        ...
        owner: {
          ...
          name: chat.otherParticipant?.name || `Owner ${chat.otherParticipantId?.slice(-4) || 'Unknown'}`,
          email: chat.otherParticipant?.email,
          phone: chat.otherParticipant?.phone,
          avatar: chat.otherParticipant?.avatar || "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face",
                  ...
                  {filteredConversations.map((conversation) => (
                    <motion.div
                      ...
                      className={`p-4 cursor-pointer transition-colors ${
                        selectedChat?.chatId === conversation.chatId ? 'bg-red-50 border-r-4 border-r-red-500' : 'hover:bg-gray-50'
                      }`}
                      ...
                      <div className="flex items-start space-x-3">
                        <div className="relative flex-shrink-0">
                          ...
                          <div className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full border-2 border-white ${
                            conversation.owner.status === 'online' ? 'bg-green-500' : 'bg-gray-400'
                          }`} />
                        </div>
                ...
                <div className="p-4 bg-white border-b border-gray-200 flex items-center justify-between">
                  <div className="flex items-center space-x-3 flex-1 min-w-0">
                    ...
                    <button
                      ...
                      className="lg:hidden p-1 hover:bg-gray-100 rounded-lg transition-colors flex-shrink-0"
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="font-semibold text-gray-900 truncate">{selectedChat.owner.name}</h3>
                      <p className="text-sm text-gray-600 truncate">{selectedChat.owner.property}</p>
                    </div>
                  </div>
